...
def obter_schema_padrao_usuario() -> Dict[str, Any]:
    ...
    return {
        ...
        "jogador": {
            "nome": "Atleta", # Genérico para novos usuários
            "nivel": 1,
            "experiencia": 0, # XP acumulado no nível atual
            "saldo_coins": 0, # Carteira para o Mercado
            "energia": 100,
        ...
        "gamificacao": {
            "xp_total": 0, # XP acumulado na vida toda (Estatística)
            "nivel": 1,
...
def obter_schema_padrao_global() -> Dict[str, Any]:
    ...
    return {
        ...
        "homeostase": { # Corrigido de 'equilibrio' para 'homeostase'
             "score_harmonia": 50,
             "estado": "Neutro",
             "componentes": {"corpo": 50, "mente": 50, "energia": 50},
             "ultima_atualizacao": ""
